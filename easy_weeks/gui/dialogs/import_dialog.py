...
from easy_weeks.database import Logger, TEACHERS
from easy_weeks.database.start_db.import_db import teacher_update
from easy_weeks.database.start_db.db_startup import create_database
from easy_weeks.database.start_db.seeds import create_empty, create_common, update_departments
